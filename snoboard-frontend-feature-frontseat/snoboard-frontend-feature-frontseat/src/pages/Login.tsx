    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
      <div className="w-full max-w-sm mx-auto space-y-8 px-6">
        ...
        <Button
          ...
          className="w-full h-12 bg-white hover:bg-zinc-100 text-zinc-900 font-medium text-sm rounded-lg flex items-center justify-center gap-3"
        >
        ...
        <p className="text-xs text-zinc-600 text-center">
          Only @owledmedia.com emails are allowed
        </p>
      </div>
    </div>
  );
